...
@Controller
public class LogoutHandlerController extends SecurityContextLogoutHandler {
     ...
     */
    @Autowired
    public LogoutHandlerController(ClientRegistrationRepository clientRegistrationRepository) {
